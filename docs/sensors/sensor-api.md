...
> ✍️ [Raathi Kugarajan](https://twitter.com/Raathigesh) has written a blog : ["Scripted natural motion with react-forked-dnd"](https://dev.to/raathigesh/scripted-natural-motion-with-react-forked-dnd-4ifj) which outlines how you can create scripted user behaviour with the Sensor API 👏
